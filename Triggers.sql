...
BEGIN
    ...
    SET data_hora_entrada = OLD.data_hora_entrada;
    ...
    IF EXISTS (SELECT 1 FROM historico WHERE placa_veiculo = placa_veiculo AND estacionamentos_id_estacionamento = id_estacionamento AND data_entrada = data_hora_entrada) THEN
